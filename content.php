          ...
          <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
              ...
              <div class="post-content">
                    ...
                    wp_link_pages( array(
                      ...
                      'link_before' => '<span>',
                      'link_after'  => '</span>',
                      'pagelink'    => '<span class="screen-reader-text">' . esc_attr__( 'Page', 'amp-accelerated-mobile-pages' ) . ' </span>%',
                  ...
                  <footer class="entry-footer">
                    ...
                    <?php edit_post_link( esc_attr__( 'Edit', 'amp-accelerated-mobile-pages' ), '<span class="edit-link">', '</span>' ); ?>
                  </footer><!-- .entry-footer -->
          </article>
      </div>
</div>
